      ...
      <Table celled>
        <Table.Header>
          <Table.Row>
            ...
            <Table.HeaderCell>Ngày thanh toán</Table.HeaderCell>
          </Table.Row>
        </Table.Header>
        <Table.Body>
          {payments.map(p => {
  ...
  render() {
    ...
    return (
      <Form onSubmit={this.handleSubmit} success={success} error={error}>
        ...
        <Form.Checkbox
          name="default"
          label="Bạn có muốn để đây là địa chỉ mặc định?"
          onChange={this.handleToggleDefault}
          checked={formData.default}
        />
        {success && (
          <Message success header="Thành công!" content="Địa chỉ thanh toán của bạn đã lưu thành công" />
        )}
        {error && (
          <Message
            error
